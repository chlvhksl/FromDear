...
const ShareSticker = forwardRef<HTMLDivElement, ShareStickerProps>(({ username }, ref) => {
        ...
        <div
            ...
            <div className="flex flex-col items-center justify-center pt-20 w-full">
                ...
                <div className="relative z-10 flex flex-col items-center space-y-4">
                    <div className="inline-block px-5 py-2 bg-red-100 text-red-600 rounded-full text-lg font-bold shadow-sm">
                        Happy Winter ❄️
                    </div>
            ...
            {/* Footer (Bottom) */ }
    <div className="relative z-10 bg-white px-8 py-3 rounded-2xl shadow-md border border-gray-100 transform rotate-2 pb-14">
    ...
    backgroundSize: '20px 20px'
            ...
            <div className="flex-1 flex flex-col items-center justify-center w-full pt-6 pb-20">
                <div className="relative z-10 bg-white/60 backdrop-blur-md p-6 rounded-3xl border border-white shadow-sm mb-6 transform -rotate-2">
                    <span className="text-7xl mb-2 block filter drop-shadow-md">🎁</span>
                </div>
            ...
            <div className="relative z-10 bg-white px-8 py-3 rounded-2xl shadow-md border border-gray-100 transform rotate-2 mb-20">
                <p className="text-gray-400 font-mono text-base font-bold tracking-widest">
                    FromDear 💌
                </p>
            </div>
